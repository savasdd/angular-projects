...
const config = {
    ...
    theme: {
        ...
        extend: {
            boxShadow: {
                '3xl': '10px 10px 16px -3px rgba(0, 0, 0, 0.5)',
                'smartButton': '10px 10px 34px -19px rgba(0,0,0,0.75)',
            },
            backgroundImage: {
                'main': "url('../../src/assets/images/bg.png')",
                'heroImg': "url('../../src/assets/img/hero-img.png')",
                'appStore': "url('../../src/assets/icons/appstore.svg')",
                'playStore': "url('../../src/assets/icons/playstore.svg')",
                'heroBg': "url('../../src/assets/img/hero-footer-bg.svg')",
            },
            animation: {
            ...
            fontFamily: {
                ...
                grotestk: 'Space Grotesk, sans-serif',
            },
            opacity: {
                12: '0.12',
                38: '0.38',
