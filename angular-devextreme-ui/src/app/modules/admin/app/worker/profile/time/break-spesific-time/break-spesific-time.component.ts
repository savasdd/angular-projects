...
@Component({
    selector: 'app-break-spesific-time',
    templateUrl: './break-spesific-time.component.html',
    styleUrls: ['./break-spesific-time.component.scss']
})
export class BreakSpesificTimeComponent {
    ...
    constructor(private genericDataSourceService: GenericDataSourceService,
        ...
        this.specificTimeDataSource = genericDataSourceFileService.instance('profilebreaks');
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        this.isvalid = this.profileData.breakParam != undefined && this.profileData.breakParam.id == DayTypesEnum.SPESIFIC ? this.priorities[0] : this.priorities[2];
